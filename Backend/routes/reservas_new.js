  ...
  try {
    ...
    try {
      ...
      if (clienteData.length > 0 && clienteData[0].correo && clienteData[0].correo.trim() !== '') {
        ...
        await axios.post('https://elrefugiocountryclub.com/api/pi/email/send-reservation-confirmation', {
    ...
    if (motivo_cancelacion && infoReserva.instructora_id) {
      try {
        ...
        if (cliente.length > 0 && cliente[0].correo && cliente[0].correo.trim() !== '') {
          ...
          axios.post('https://elrefugiocountryclub.com/api/pi/email/send-cancellation-notification', emailPayload)
            .then(() => {
