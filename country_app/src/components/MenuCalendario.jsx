...
function CalendarContent({ userLevel, userId, userName, userType, onLogout, onChangePassword }) {
  ...
  const handleConfirm = async () => {
    ...
    try {
      ...
      const res = await fetch(`https://elrefugiocountryclub.com/api/pi/users/${userIdLocal}`);
    ...
    useEffect(() => {
      ...
      const checkUserLevel = async () => {
        ...
        try {
          ...
          const response = await fetch(`https://elrefugiocountryclub.com/api/pi/users/${userId}`);
